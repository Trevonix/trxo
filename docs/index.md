...
**TRXO** is a configuration management and deployment tool for Ping Identity platforms — PingOne, PingAM, and PingIDM.
...
- Intelligent diff preview for OAuth2 clients and managed objects
