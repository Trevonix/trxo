...
def create_journeys_export_command():
    ...
    def export_journeys(
        ...
        info(
            "NOTE: Journey exports currently include the journey definitions "
            "only. Dependent resources (such as nodes and related "
            "configurations) are not included yet and will be added in a "
            "future release."
        )
        ...
        exporter.export_data(
            ...
            api_endpoint=(
                ...
                "authentication/authenticationtrees/trees?_queryFilter=true"
            ),
            headers=headers,
            view=view,
