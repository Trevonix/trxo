...
def test_apply_filter_happy_path_id_match(mocker):
    mocker.patch("trxo_lib.imports.helpers.cherry_pick_filter.logger.info")
    mocker.patch("trxo_lib.imports.helpers.cherry_pick_filter.logger.error")
...
def test_apply_filter_missing_id_logs_error(mocker):
    error_mock = mocker.patch("trxo_lib.imports.helpers.cherry_pick_filter.logger.error")
    mocker.patch("trxo_lib.imports.helpers.cherry_pick_filter.logger.info")
