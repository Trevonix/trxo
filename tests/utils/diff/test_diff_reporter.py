...
from trxo_lib.utils.diff.diff_engine import ChangeType, DiffResult
...
def test_display_summary_exception(mocker):
    ...
    mocker.patch("trxo_lib.utils.diff.diff_reporter.error")
...
def test_generate_html_diff_success(tmp_path, mocker):
    rep = DiffReporter()
    mocker.patch("trxo_lib.utils.diff.diff_reporter.success")
...
def test_generate_html_diff_failure(mocker):
    rep = DiffReporter()
    mocker.patch("trxo_lib.utils.diff.diff_reporter.info")
    mocker.patch("trxo_lib.utils.diff.diff_reporter.error")
