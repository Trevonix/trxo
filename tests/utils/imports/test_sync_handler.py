...
def test_handle_sync_deletions_diff_fails(mocker):
    mocker.patch("trxo_lib.utils.imports.sync_handler.info")
    mocker.patch("trxo_lib.utils.imports.sync_handler.warning")
    mocker.patch("trxo_lib.utils.imports.sync_handler.success")

    diff_manager = MagicMock()
    diff_manager.perform_diff.return_value = None
    mocker.patch(
        "trxo_lib.utils.imports.sync_handler.DiffManager", return_value=diff_manager
    )
...
def test_handle_sync_deletions_no_items_to_delete(mocker):
    mocker.patch("trxo_lib.utils.imports.sync_handler.info")
    mocker.patch("trxo_lib.utils.imports.sync_handler.warning")
    success_mock = mocker.patch("trxo_lib.utils.imports.sync_handler.success")
    ...
    mocker.patch(
        "trxo_lib.utils.imports.sync_handler.DeletionManager", return_value=deletion_manager
    )
...
def test_handle_sync_deletions_user_cancels(mocker):
    mocker.patch("trxo_lib.utils.imports.sync_handler.info")
    warning_mock = mocker.patch("trxo_lib.utils.imports.sync_handler.warning")
